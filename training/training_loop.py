...
def training_loop(
        ...
        augment_kwargs=None,  # Options for augmentation pipeline. None = disable.  # noqa
        loss_kwargs={},  # Options for loss function.
        metrics=[],  # Metrics to evaluate during training.
        random_seed=0,  # Global random seed.
        num_gpus=1,  # Number of GPUs participating in the training.
        rank=0,  # Rank of the current process in [0, num_gpus[.
        batch_size=4,  # Total batch size for one training iteration. Can be larger than batch_gpu * num_gpus.  # noqa
        batch_gpu=4,  # Number of samples processed at a time by one GPU.
        ema_kimg=10,  # Half-life of the exponential moving average (EMA) of generator weights.  # noqa
        ema_rampup=0.05,  # EMA ramp-up coefficient. None = no rampup.
        G_reg_interval=None,  # How often to perform regularization for G? None = disable lazy regularization.  # noqa
        D_reg_interval=16,  # How often to perform regularization for D? None = disable lazy regularization.  # noqa
        augment_p=0,  # Initial value of augmentation probability.
        ada_target=None,  # ADA target value. None = fixed p.
        ada_interval=4,  # How often to perform ADA adjustment?
        ada_kimg=500,  # ADA adjustment speed, measured in how many kimg it takes for p to increase/decrease by one unit.  # noqa
        total_kimg=25000,  # Total length of the training, measured in thousands of real images.  # noqa
        kimg_per_tick=4,  # Progress snapshot interval.
        image_snapshot_ticks=50,  # How often to save image snapshots? None = disable.   # noqa
        network_snapshot_ticks=50,  # How often to save network snapshots? None = disable.  # noqa
        resume_pkl=None,  # Network pickle to resume training from.
        resume_kimg=0,  # First kimg to report when resuming training.
        cudnn_benchmark=True,  # Enable torch.backends.cudnn.benchmark?
        abort_fn=None,  # Callback function for determining whether to abort training. Must return consistent results across ranks.  # noqa
        progress_fn=None,  # Callback function for updating training progress. Called for all ranks.  # noqa
    ...
    torch.backends.cudnn.benchmark = cudnn_benchmark  # Improves training speed.  # noqa
    torch.backends.cuda.matmul.allow_tf32 = False  # Improves numerical accuracy.  # noqa
    torch.backends.cudnn.allow_tf32 = False  # Improves numerical accuracy.
    conv2d_gradfix.enabled = True  # Improves training speed.
    grid_sample_gradfix.enabled = True  # Avoids errors with the augmentation pipe.  # noqa
    ...
    # Initialize logs. -->
    #   move this part to above draw image to initialize client
    if rank == 0:
